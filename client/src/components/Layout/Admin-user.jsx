        ...
        addNewUser
          ...
          (
            ...
            <div >
              ...
              <div className="p-5 grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-4 relative" >
                ...
                <button
                  onClick={() => ActiveAddToNewUser(true)}
                  className='p-1 ml-3'
                >
                  <img src={adduser} alt="" className="w-60 h-60 " />
                </button>

                {confirmUser && (
                  <div className="absolute inset-0 flex justify-center items-center bg-gray-500/50 z-10">
